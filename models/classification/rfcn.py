...
from models.classification.sqeezenet import DilationLayer, FeatExtractorSqueezeNetx16
...
class Extractor(nn.Module):
    ...
    def __init__(self, extractor='squeezenet', pretrained=False):
        super(Extractor, self).__init__()
        self.feature_extractor = FeatExtractorSqueezeNetx16(pretrained)
